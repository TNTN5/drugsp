...
<body> 
	...
	<c:forEach items="${message }" var="m">
		...
		<div class="content">
		<form method="post" action="<%=path %>/replyadd.do">
			<div class="layui-form-item hidden">
		    <div class="layui-input-block">
		      <input type="hidden" name="sid" value="${sid }" required  lay-verify="required"  autocomplete="off" class="layui-input">
		    </div>
		  	</div>
		  	<div class="layui-form-item hidden">
		    <div class="layui-input-block">
		      <input type="hidden" name="mid" value="${m.mid }" required  lay-verify="required"  autocomplete="off" class="layui-input">
		    </div>
		  	</div>
